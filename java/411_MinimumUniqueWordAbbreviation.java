...
public class Solution {
	// idea: use Trie to build a dictionary with a function to check abbreviation. DFS + backtracking to
	// generate the abbreviations of a given length, and Binary Search to find the smallest possible length.
	class TrieNode {
		TrieNode[] nodes;
		boolean isWord;
		TrieNode() {
