...
public class Solution {
	// idea: DFS + backtracking, Match the first letter and do dfs from here. mark visited cells
	// during dfs searching, then backtracking after searching all following paths of this pos. 
	...
	// dfs searching to check if can find a target word
