...
public class Solution {
    public int minDistance(String word1, String word2) {
        // idea: DP. O(mn) Time. dp[i][j] is the minimum number of operations to 
        // convert word1[0..i-1] to word2[0..j-1]. Boundary cases: dp[i][0] = i, dp[0][j] = j;
        // suppose word1[i-1] == c, word2[j-1] == d: 0. If c == d, dp[i][j] = dp[i-1][j-1]; otherwise
